...
module Allocation
  class Setup
    ...
    def setup_subscriptions_to_be_updated
        ...
        subs_update_june_new_subs = "insert into subscriptions_next_month_updated (subscription_id, customer_id, updated_at, created_at, next_charge_scheduled_at, product_title, status, sku, shopify_product_id, shopify_variant_id, raw_line_items) select subscriptions.subscription_id, subscriptions.customer_id, subscriptions.updated_at, subscriptions.created_at, subscriptions.next_charge_scheduled_at, subscriptions.product_title, subscriptions.status, subscriptions.sku, subscriptions.shopify_product_id, subscriptions.shopify_variant_id, subscriptions.raw_line_item_properties from subscriptions where subscriptions.status = 'ACTIVE' and subscriptions.next_charge_scheduled_at > '2020-06-30' and subscriptions.next_charge_scheduled_at < '2020-08-01' and subscriptions.created_at > '2020-05-31' and subscriptions.created_at < '2020-07-01' and subscriptions.product_title not ilike \'3%month%\' "
