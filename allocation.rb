...
module Allocation
  class Setup
    ...
    def setup_subscriptions_to_be_updated
        ...
        subs_update = "insert into subscriptions_next_month_updated (subscription_id, customer_id, updated_at, created_at, next_charge_scheduled_at, product_title, status, sku, shopify_product_id, shopify_variant_id, raw_line_items) select subscription_id, customer_id, updated_at, created_at, next_charge_scheduled_at, product_title, status, sku, shopify_product_id, shopify_variant_id, raw_line_item_properties from subscriptions where status = 'ACTIVE' and (next_charge_scheduled_at is not null and next_charge_scheduled_at > \'2020-07-31\' and next_charge_scheduled_at < \'2020-09-01\')  and product_title not ilike \'3%month%\' and product_title ilike \'%- 5 item%\' and product_title not ilike \'second%skin%\' and product_title not ilike \'city%limit%\' and product_title not ilike \'gear%up%\' "

        #subs_update = "insert into subscriptions_next_month_updated (subscription_id, customer_id, updated_at, created_at, next_charge_scheduled_at, product_title, status, sku, shopify_product_id, shopify_variant_id, raw_line_items) select subscriptions.subscription_id, subscriptions.customer_id, subscriptions.updated_at, subscriptions.created_at, subscriptions.next_charge_scheduled_at, subscriptions.product_title, subscriptions.status, subscriptions.sku, subscriptions.shopify_product_id, subscriptions.shopify_variant_id, subscriptions.raw_line_item_properties from subscriptions, sub_collection_sizes where subscriptions.status = 'ACTIVE' and subscriptions.next_charge_scheduled_at > '2020-06-30' and sub_collection_sizes.subscription_id = subscriptions.subscription_id and  subscriptions.next_charge_scheduled_at < '2020-08-01' and ( sub_collection_sizes.leggings = 'XS' or sub_collection_sizes.tops = 'XS'  or sub_collection_sizes.sports_bra = 'XS') and subscriptions.product_title not ilike '3%month%' and subscriptions.product_title not ilike 'berry%crush%' and subscriptions.product_title not ilike 'summer%sunset%' and subscriptions.product_title not ilike 'renewal%' and subscriptions.product_title not ilike 'twilight%' and subscriptions.product_title not ilike 'wild%instinct%' and subscriptions.product_title not ilike 'serve%up%' and subscriptions.product_title not ilike 'hibiscus%' and subscriptions.product_title not ilike 'bright%idea%' and subscriptions.product_title not ilike 'ooh%la%' and subscriptions.product_title not ilike 'peach%sorbet%' and subscriptions.product_title not ilike 'pinky%swear%' and subscriptions.product_title not ilike 'hillside%hike%' and subscriptions.product_title not ilike 'one%mile%' and subscriptions.product_title not ilike 'bootcamp%beauty%' and subscriptions.product_title not ilike 'moonlight%rose%'  and subscriptions.product_title not ilike 'laguna%getaway%' and subscriptions.product_title not ilike 'bootcamp%beauty%'"
