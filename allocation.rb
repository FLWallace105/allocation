...
module Allocation
  class Setup
    ...
    def setup_subscriptions_to_be_updated
        ...
        subs_update = "insert into subscriptions_next_month_updated (subscription_id, customer_id, updated_at, created_at, next_charge_scheduled_at, product_title, status, sku, shopify_product_id, shopify_variant_id, raw_line_items) select subscriptions.subscription_id, subscriptions.customer_id, subscriptions.updated_at, subscriptions.created_at, subscriptions.next_charge_scheduled_at, subscriptions.product_title, subscriptions.status, subscriptions.sku, subscriptions.shopify_product_id, subscriptions.shopify_variant_id, subscriptions.raw_line_item_properties from subscriptions, sub_collection_sizes where subscriptions.status = 'ACTIVE' and subscriptions.next_charge_scheduled_at > '2020-12-31' and sub_collection_sizes.subscription_id = subscriptions.subscription_id and  subscriptions.next_charge_scheduled_at < '2021-01-06' and  subscriptions.product_title not ilike '3%month%'  and subscriptions.is_prepaid = \'f\' and ( sub_collection_sizes.product_collection not ilike 'test%value%'  ) and (sub_collection_sizes.sports_bra != 'XS' and sub_collection_sizes.sports_jacket != 'XS' and sub_collection_sizes.leggings != 'XS' and sub_collection_sizes.tops != 'XS')"
